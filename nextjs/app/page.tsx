        ...
        <div className="cart-body">
          {needsConfiguration ? (
            <section className="setup-card has-config-error" role="status">
              ...
              <div className="setup-actions"><a href="https://studio.inttegro.com/keys">Create an API key</a><a href="https://github.com/zebodotdev/inttegro-demos/blob/nextjs-v1.6.0/nextjs/README.md#deploy-your-own">Deployment guide</a></div>
            </section>
