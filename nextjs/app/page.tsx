        ...
        <div className="cart-body">
          {needsConfiguration ? (
            <section className="setup-card has-config-error" role="status">
              ...
              <div className="setup-actions"><a href="https://studio.inttegro.com/keys">Create a test key</a><a href="https://github.com/zebodotdev/inttegro-demos/blob/nextjs-v1.1.3/nextjs/README.md#deploy-your-own">Deployment guide</a></div>
            </section>
