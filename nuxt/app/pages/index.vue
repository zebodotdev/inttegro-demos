    ...
    <dialog class="cart-dialog" data-cart-dialog :data-auto-open="errorCode ? '' : undefined">
      ...
      <div class="cart-body">
        <section v-if="needsConfiguration" class="setup-card has-config-error" role="status">
          ...
          <div class="setup-actions"><a href="https://studio.inttegro.com/keys">Create an API key</a><a href="https://github.com/zebodotdev/inttegro-demos/blob/nuxt-v1.6.0/nuxt/README.md#deploy-your-own">Deployment guide</a></div>
        </section>
