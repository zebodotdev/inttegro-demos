...
[![Deploy to Cloud Run](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.8.0/assets/providers/cloud-run-button.svg)](https://deploy.cloud.run/?git_repo=https%3A%2F%2Fgithub.com%2Fzebodotdev%2Finttegro-demos.git&revision=deploy-fastapi-v1.8.0)
[![Deploy to Cloudflare](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.8.0/assets/providers/cloudflare-button.svg)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-fastapi-v1.8.0)
...
[![Deploy on Railway](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.8.0/assets/providers/railway-button.svg)](https://railway.com/new/template/wk2B6a?utm_medium=integration&utm_source=inttegro-demos&utm_campaign=fastapi)
[![Deploy to Render](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.8.0/assets/providers/render-button.svg)](https://render.com/deploy?repo=https%3A%2F%2Fgithub.com%2Fzebodotdev%2Finttegro-demos%2Ftree%2Fdeploy-fastapi-v1.8.0)
...
runtime locally. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.8.0/DEPLOYING.md) for provider details. The package `predeploy`
