...
credentials. The buttons become live when release `nextjs-v1.2.2` is published. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.2/DEPLOYING.md) for the security contract and verification
status.
