...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https%3A%2F%2Fgithub.com%2Fzebodotdev%2Finttegro-demos%2Ftree%2Fdeploy-django-v1.2.0)
...
currently uses synchronous `urllib`. See [`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.0/DEPLOYING.md) for
