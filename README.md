...
[![Deploy to Cloudflare](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.6.2/assets/providers/cloudflare-button.svg)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-redwoodsdk-v1.6.2)

RedwoodSDK is Cloudflare-native. The button starts from the immutable 1.6.2
...
See [`INTEGRATION_GUIDE.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.6.2/INTEGRATION_GUIDE.md) and
[`integration-decisions.json`](https://github.com/zebodotdev/inttegro-demos/blob/v1.6.2/integration-decisions.json) for the complete
