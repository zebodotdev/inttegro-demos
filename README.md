...
[![Deploy to Cloudflare](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.6.1/assets/providers/cloudflare-button.svg)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-nuxt-v1.6.1)
...
the published `nuxt-v1.6.1` deployment ref. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.6.1/DEPLOYING.md) for readiness
and trade-offs.
