...
The current release is **1.6.0**. Use
[`releases/v1.6.0.json`](./releases/v1.6.0.json) to resolve each demo to its
...
NestJS and RedwoodSDK are included in **1.6.0**. They share the Openfield
