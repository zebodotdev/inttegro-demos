...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-nuxt-v1.2.3)
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fzebodotdev%2Finttegro-demos%2Ftree%2Fdeploy-nuxt-v1.2.3&project-name=inttegro-demo-nuxt&repository-name=inttegro-demo-nuxt&env=NUXT_INTTEGRO_API_KEY%2CNUXT_DEMO_PRODUCT_ID%2CNUXT_DEMO_PRICE_ID%2CNUXT_DEMO_PUBLIC_URL&envDescription=Add%20a%20dedicated%20Inttegro%20API%20key%2C%20active%20Product%20and%20Price%20IDs%2C%20and%20the%20public%20origin.&envLink=https%3A%2F%2Fstudio.inttegro.com%2Fkeys)
...
`nuxt-v1.2.3` and become live when
that release is published. See [`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.3/DEPLOYING.md) for readiness
and trade-offs.
...
alternatives to the shared [integration guide](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.3/INTEGRATION_GUIDE.md) and
[machine-readable decision registry](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.3/integration-decisions.json).
