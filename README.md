...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-nextjs-v1.2.3)
...
credentials. The buttons become live when release `nextjs-v1.2.3` is published. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.3/DEPLOYING.md) for the security contract and verification
status.
...
[integration guide](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.3/INTEGRATION_GUIDE.md) and
