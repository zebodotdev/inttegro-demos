...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fzebodotdev%2Finttegro-demos%2Ftree%2Fdeploy-nextjs-v1.1.1&project-name=inttegro-demo-nextjs&repository-name=inttegro-demo-nextjs&env=INTTEGRO_API_KEY%2CINTTEGRO_DEMO_CUSTOMER_ID%2CINTTEGRO_DEMO_PUBLIC_URL&envDescription=Add%20an%20Inttegro%20test%20API%20key%20and%20the%20public%20origin%20assigned%20to%20this%20deployment.&envLink=https%3A%2F%2Fstudio.inttegro.com%2Fkeys)
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-nextjs-v1.1.1)
...
credentials. The buttons become live when release `nextjs-v1.1.1` is published. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.1.1/DEPLOYING.md) for the security contract and verification
status.
