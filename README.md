...
credentials. The buttons become live when release `nextjs-v1.2.1` is published. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.2.1/DEPLOYING.md) for the security contract and verification
status.
