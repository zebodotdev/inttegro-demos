...
[![Deploy to Cloudflare](https://raw.githubusercontent.com/zebodotdev/inttegro-demos/v1.8.2/assets/providers/cloudflare-button.svg)](https://deploy.workers.cloudflare.com/?url=https://github.com/zebodotdev/inttegro-demos/tree/deploy-nextjs-v1.8.2)
...
credentials. Both buttons use the published `nextjs-v1.8.2` deployment ref. See
[`DEPLOYING.md`](https://github.com/zebodotdev/inttegro-demos/blob/v1.8.2/DEPLOYING.md) for the security contract and verification
status.
